            ...
            for( let pkg of shipping.packages )
            {
                ...
                if( pkg.constraints )
                {
                    for( let type in pkg.constraints )
                    {
                        ...
                        {
                            if( constraint.min && weight < constraint.min ){ available = false; hint = constraint?.min?.note?.[locale]; break; }
                            if( constraint.max && weight > constraint.max ){ available = false; hint = constraint?.max?.note?.[locale]; break; }
                        }
                    }
                }
