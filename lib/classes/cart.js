...
module.exports = class Cart
{
    ...
    async submit( price, options )
    {
        ...
        let domain = options.domain || ( this.#ctx.websites.find( website => website.country === country ) || {} ).domain;
        ...
        let estimatedTime = 0,
            ...
            order = { price, paid: 0, profit: 0, country, locale, domain, estimatedTime: 0 };
        ...
        let result = await Request.post( 'https://devel.'+domain+'/admin/order/set' , { body: { customer, order, products }});
