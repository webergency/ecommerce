    ...
    async submit( price, options )
    {
        ...
        for( let item of this.products )
        {
            ...
            products.push(
            {
                ...
                supplier            : item.product.suppliers[0].id,
                supplierProductID   : item.product.suppliers[0].productID,
                supplierVariationID : item.product.suppliers[0].variationID || '',
                supplierUID         : item.product.suppliers[0].productID + ( item.product.suppliers[0].variationID ? ':' + item.product.suppliers[0].variationID : '' ),
                physical            : 1,
                data                : { image: item.product.images.length ? item.product.images[0].url : null }
            });
        }
