...
const DEFAULT_SCOPE = 
{
    list    : [ 'name', 'title', 'subcategories', 'url', 'image' ],
    detail  : [ 'name', 'title', 'subcategories', 'url', 'image', 'description', 'filter', 'faq' ]
};

const ORDER =
{
    'top'       : ( scope ) => ({[ `top._${scope.country}` ]: 1, [ `_id` ]: -1 }),
    'new'       : ( scope ) => ({[ `__model.created` ]: 1, [ `top._${scope.country}` ]: 1, [ `_id` ]: -1 }),
    'popular'   : ( scope ) => ({[ `top._${scope.country}` ]: 1, [ `_id` ]: -1 }),
    'review'    : ( scope ) => ({[ `rating.value` ]: -1, [ `rating.count` ]: -1, [ `top._${scope.country}` ]: 1, [ `_id` ]: -1 }),
    'cheap'     : ( scope ) => ({[ `price.current._${scope.country}` ]: 1, [ `top._${scope.country}` ]: 1, [ `_id` ]: -1 }),
    'expensive' : ( scope ) => ({[ `price.current._${scope.country}` ]: -1, [ `top._${scope.country}` ]: 1, [ `_id` ]: -1 }),
    'discount'  : ( scope ) => ({[ `price.discount._${scope.country}` ]: -1, [ `top._${scope.country}` ]: 1, [ `_id` ]: -1 }),
    'deduction' : ( scope ) => ({[ `price.discount._${scope.country}` ]: -1, [ `top._${scope.country}` ]: 1, [ `_id` ]: -1 }),
    'a-z'       : ( scope ) => ({[ `name._${scope.locale}` ]: 1, [ `top._${scope.country}` ]: 1, [ `_id` ]: -1 }),
    'z-a'       : ( scope ) => ({[ `name._${scope.locale}` ]: -1, [ `top._${scope.country}` ]: 1, [ `_id` ]: -1 })
};
