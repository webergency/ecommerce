...
const ORDER =
{
    'top'       : ( scope ) => ({[ `top._${scope.country}` ]: 1 }),
    'new'       : ( scope ) => ({[ `__model.created` ]: 1 }),
    'popular'   : ( scope ) => ({[ `top._${scope.country}` ]: 1 }),
    'review'    : ( scope ) => ({[ `top._${scope.country}` ]: 1 }),
    'cheap'     : ( scope ) => ({[ `price.current._${scope.country}` ]: 1 }),
    'expensive' : ( scope ) => ({[ `price.current._${scope.country}` ]: -1 }),
    'discount'  : ( scope ) => ({[ `price.discount._${scope.country}` ]: -1 }),
    'deduction' : ( scope ) => ({[ `price.discount._${scope.country}` ]: -1 }),
    'a-z'       : ( scope ) => ({[ `name._${scope.locale}` ]: 1 }),
    'z-a'       : ( scope ) => ({[ `name._${scope.locale}` ]: -1 })
};
