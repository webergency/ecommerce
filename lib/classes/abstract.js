        ...
        if( this[LOADED] !== true && ( scope === undefined || scope.length )) // TODO pocachrovat este s loading
        {
            ...
            if( scope === undefined || scope.length )
            {
                ...
                try
                {
                    ...
                    let data = await this.constructor[LOADER]( this[CTX].core ).get( this.id, scope ).catch( e => 
                    {
                        if( e.code === 404 ){ this.#exists = false; }

                         // TODO handlovat podla kodu chyby
                    })
                    ...
                    if( this.#exists !== false ){ this.#exists = true }
